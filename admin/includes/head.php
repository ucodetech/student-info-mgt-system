    ...
    -->
    	...
    	<div class="sidebar-wrapper">
             ...
             require_once '../core/init.php';
              ...
              if (mysqli_num_rows($query) > 0) {
                while ($row = mysqli_fetch_assoc($query)) {
                  ...
                  $sqlim = "SELECT * FROM admintprofile WHERE admin_id = '$adminid' ";
                  ...
                  if (mysqli_num_rows($queryim) > 0) {
                    while ($rowimg = mysqli_fetch_assoc($queryim)) {
                        ...
                        if ($rowimg['status'] == 0) {
                          echo "<img src='profile/profile".$adminid.".jpg?'".mt_rand()." class='rounded-circle align-self-start mr-3' style='border-radius: 50% !important;margin: 2px;' alt='...' width='80' height='80'>
           ...
           ?>
              ...
              <span class="nam text-default" ><?=$user_data['first']  ?><?=" "?><?=$user_data['last']  ?></span ><br>
             <span class="text-warning" style="margin: 10px;">last_login: <?=pretty_date($user_data['last_login']);?></span>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="logout.php">
                               <p>Log out</p> <span class="text-danger"><?=$user_data['first'];?> </span>
                            </a>
                        </li>
