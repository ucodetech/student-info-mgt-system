  ...
  include 'includes/head1.php';
   ...
   if (isset($_GET['delete'])) {
     $deleteid = (int)$_GET['delete'];
      $singlesResults = $db->query("UPDATE student_marks SET deleted = '' WHERE id = '$deleteid'");
    $_SESSION['success_flash'] = 'deleted';
      header("Location: student_marks.php?success");
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title"><?=((isset($_GET['edit']))? 'Edit Score': 'Student Score');?></h4>
                            </div>
                            <div class="content">
                                <?php
