          ...
          <?php 
              ...
              if (mysqli_num_rows($query) > 0) {
                while ($row = mysqli_fetch_assoc($query)) {
                  ...
                  $sqlim = "SELECT * FROM adminprofile WHERE admin_id = '$adminid' ";
           ...
           ?>
              ...
              <span class="nam text-default" ><?=$user_id['first']  ?><?=" "?><?=$user_id['last']  ?></span ><br>
             <span class="text-warning" style="margin: 10px;">last_login: <?=pretty_date($user_id['last_login']);?></span>
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            ...
                            <a href="logout.php">
                                Log out:<span class="text-danger"><?=$user_id['first']  ?></span>
                            </a>
                        </li>
                    </ul>
                </div>
